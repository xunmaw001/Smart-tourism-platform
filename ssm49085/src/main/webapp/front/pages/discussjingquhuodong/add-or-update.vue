	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`discussjingquhuodong`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
				...
				if(this.ruleForm.id){
					await this.$api.update(`discussjingquhuodong`, this.ruleForm);
				}else{
					await this.$api.add(`discussjingquhuodong`, this.ruleForm);
				}
				uni.setStorageSync('discussjingquhuodongCleanType',true);
